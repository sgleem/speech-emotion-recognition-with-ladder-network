...
unlabel_dir=/media/kyunster/hdd/corpus/MSP_Podcast_1.8/unlabeled || exit 1; # Make sure that all unlabeled wav files are in this folder and sampled with 16kHz.
unlabel_feature_dir=./feature/unlabeled || exit 1;
unlabel_data_dir=./data/unlabeled || exit 1;

bash extract_unlabel.sh ${opensmile_dir}/config ${unlabel_dir} || exit 1;
